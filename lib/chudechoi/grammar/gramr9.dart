...
import 'package:phan4_bai1/chudechoi/grammar/choilai/grampar9.dart';
...
class cauhoi8 extends StatefulWidget {
  const cauhoi8({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<cauhoi8> createState() => _cauhoiState();
}

class _cauhoiState extends State<cauhoi8> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 40;
                ...
                return AnswerTile(
                  ...
                  onTap: () {
                    ...
                    Future.delayed(Duration(milliseconds: 200), () {
                      if (_crindex == widget.questions.length - 4) {
