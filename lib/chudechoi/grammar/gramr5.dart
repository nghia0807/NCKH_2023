...
import 'package:phan4_bai1/chudechoi/grammar/choilai/grampar5.dart';
...
class cauhoi4 extends StatefulWidget {
  const cauhoi4({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<cauhoi4> createState() => _cauhoiState();
}

class _cauhoiState extends State<cauhoi4> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 20;
                ...
                return AnswerTile(
                  ...
                  onTap: () {
                    ...
                    Future.delayed(Duration(milliseconds: 200), () {
                      if (_crindex == widget.questions.length - 24) {
