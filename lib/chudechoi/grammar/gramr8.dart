...
import 'package:phan4_bai1/chudechoi/grammar/choilai/grampar8.dart';
...
class cauhoi7 extends StatefulWidget {
  const cauhoi7({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<cauhoi7> createState() => _cauhoiState();
}

class _cauhoiState extends State<cauhoi7> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 35;
                ...
                return AnswerTile(
                  ...
                  onTap: () {
                    ...
                    Future.delayed(Duration(milliseconds: 200), () {
                      if (_crindex == widget.questions.length - 9) {
