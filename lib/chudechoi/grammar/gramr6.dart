...
import 'package:phan4_bai1/chudechoi/grammar/choilai/grampar6.dart';
...
class cauhoi5 extends StatefulWidget {
  const cauhoi5({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<cauhoi5> createState() => _cauhoi5State();
}

class _cauhoi5State extends State<cauhoi5> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 25;
                ...
                return AnswerTile(
                  ...
                  onTap: () {
                    ...
                    Future.delayed(Duration(milliseconds: 200), () {
                      if (_crindex == widget.questions.length - 19) {
