...
import 'package:phan4_bai1/chudechoi/grammar/choilai/grampar1.dart';
import 'package:phan4_bai1/chudechoi/grammar/choilai/grampar2.dart';
...
class cauhoi1 extends StatefulWidget {
  ...
  @override
  State<cauhoi1> createState() => _cauhoiState();
}

class _cauhoiState extends State<cauhoi1> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 5;
                ...
                return AnswerTile(
                  ...
                  onTap: () {
                    ...
                    Future.delayed(Duration(milliseconds: 200), () {
                      if (_crindex == widget.questions.length - 39) {
