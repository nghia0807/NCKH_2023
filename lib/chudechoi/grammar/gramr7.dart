...
import 'package:phan4_bai1/chudechoi/grammar/choilai/grampar7.dart';
...
class cauhoi6 extends StatefulWidget {
  const cauhoi6({Key? key, required this.totalTimer, required this.questions})
      : super(key: key);
  ...
  @override
  State<cauhoi6> createState() => _cauhoi6State();
}

class _cauhoi6State extends State<cauhoi6> {
  late int crtimer;
  late Timer _timer;
  int _crindex = 30;
                ...
                return AnswerTile(
                  ...
                  onTap: () {
                    ...
                    Future.delayed(Duration(milliseconds: 200), () {
                      if (_crindex == widget.questions.length - 14) {
